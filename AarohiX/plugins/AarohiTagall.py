...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("/tagall hola 👈 Next time try this for tagging..")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        if not msg:
            return await message.reply("/tagall hello 👈 Try this or reply any message...")
    else:
        return await message.reply("/tagall Hello 👈 Try this or reply any message...")
...
async def cancel_spam(client, message):
    ...
    try:
        ...
        if participant.status in ("administrator", "creator"):
            is_admin = True
    if not is_admin:
        return await message.reply("This command is only for admins🌚. JAKE PHLE ADMIN BN,THEN USE ME🤣.")
    else:
        try:
